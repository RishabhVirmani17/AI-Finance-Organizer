...
# Ensure .env is loaded from this file's directory so Streamlit finds the key
...
def main():
    ...
    # Replace tabs with a simple flow header and container
    st.subheader("Let's get started")
    input_tab = st.container()
    about_tab = None  # We'll render About in an expander later
